...
public class ExampleSceneManagerController : MonoBehaviour
{
    ...
    public void Upload()
    {
        ...
        //string localPath = "/cache/IMG_camera.jpg";
        string localPath = "/cache/IMG_camera.jpg";
        ...
        content.Add(streamContent, "file", localPath);

        string fileType = "txt";

        client.Post(new System.Uri("http://127.0.0.1:8080/main/user/upload/" + fileType), content, HttpCompletionOption.AllResponseContent, (r) =>
        {           
        }, (u) =>
        {
